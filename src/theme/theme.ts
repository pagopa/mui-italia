...
import foundationNext from './foundations/foundationNext';
...
export const theme: Theme = createTheme(foundation, {
  ...
  components: {
      ...
      variants: [
        ...
        },
        {
          ...
          style: {
            ...
            '&:hover': {
              color: foundation.palette.primaryContained.hover,
            },
            '&.Mui-focusVisible': {
              borderRadius: `${focusBorderRadius}`,
              outline: `solid ${focusWidth} ${foundation.palette.primary.main}`,
      ...
      styleOverrides: {
        ...
        outlined: {
          ...
          '&.MuiChip-outlinedPrimary': {
            color: foundation.palette.text.primary,
            borderColor: foundation.palette.text.primary,
          },
        },
        filled: {
    ...
    MuiBackdrop: {
      styleOverrides: {
        root: {
          backgroundColor: alpha(foundation.palette.backdrop.background, 0.7),
        },
        invisible: {
          backgroundColor: 'transparent',
        },
    ...
    MuiMenuItem: {
      ...
      styleOverrides: {
        root: {
          ...
          '&:hover': {
            backgroundColor: alpha(foundation.palette.menuItem.background, 0.04),
          },
        },
      },
    },
  ...
  components: {
    ...
    MuiChip: {
      styleOverrides: {
        root: {
          height: 'auto',
          borderRadius: foundationNext.spacing(5),
        },
        label: {
          fontSize: pxToRem(14),
          fontWeight: foundationNext.typography.fontWeightMedium,
          ...
          whiteSpace: 'normal',
          textOverflow: 'clip',
          padding: `${foundationNext.spacing(1)} ${foundationNext.spacing(1.5)}` /* 8px 12px */,
        },
        labelSmall: {
          padding: `${foundationNext.spacing(0.5)} ${foundationNext.spacing(1)}` /* 4px 8px */,
        },
        deleteIcon: {
          color: 'currentColor',
          opacity: '0.7',
        ...
        outlined: {
          ...
          '&.MuiChip-outlinedDefault': {
            ...
            borderColor: '#0000003B',
            '& .MuiChip-avatar': {
              backgroundColor: foundationNext.palette.grey[400],
              color: '#17324D',
            },
          },
          '&.MuiChip-outlinedPrimary': {
            color: foundationNext.palette.text.primary,
            borderColor: foundationNext.palette.text.primary,
          },
        },
        filled: {
          '&.MuiChip-colorDefault': {
            backgroundColor: foundationNext.palette.grey[200],
            color: foundationNext.palette.text.primary,
          },
          '&.MuiChip-colorPrimary': {
            backgroundColor: foundationNext.palette.primary[100],
            color: foundationNext.palette.text.primary,
          },
          '&.MuiChip-colorSecondary': {
            backgroundColor: alpha(foundationNext.palette.secondary.main, 0.5),
            color: foundationNext.palette.text.primary,
          },
          '&.MuiChip-colorInfo': {
            backgroundColor: foundationNext.palette.info[100],
            color: foundationNext.palette.info[850],
          },
          '&.MuiChip-colorError': {
            backgroundColor: foundationNext.palette.error[100],
            color: foundationNext.palette.error[850],
          },
          '&.MuiChip-colorSuccess': {
            backgroundColor: foundationNext.palette.success[100],
            color: foundationNext.palette.success[850],
          },
          '&.MuiChip-colorWarning': {
            backgroundColor: foundationNext.palette.warning[100],
            color: foundationNext.palette.warning[850],
          },
        },
        colorDefault: {
          '& .MuiChip-avatar': {
            backgroundColor: foundationNext.palette.grey[400],
            color: foundationNext.palette.grey[700],
          },
          '& .MuiChip-deleteIcon': {
            color: alpha(foundationNext.palette.text.primary, 0.23),
          },
        },
        colorPrimary: {
          '& .MuiChip-avatar': {
            backgroundColor: foundationNext.palette.primary.light,
            color: foundationNext.palette.primary.contrastText,
          },
          '& .MuiChip-deleteIcon': {
            color: foundationNext.palette.text.primary,
        ...
        colorInfo: {
          '& .MuiChip-avatar': {
            backgroundColor: foundationNext.palette.info.light,
            color: foundationNext.palette.info[850],
          },
          '& .MuiChip-deleteIcon': {
            color: foundationNext.palette.info[850],
        ...
        colorError: {
          '& .MuiChip-avatar': {
            backgroundColor: foundationNext.palette.error.light,
            color: foundationNext.palette.error[850],
          },
          '& .MuiChip-deleteIcon': {
            color: foundationNext.palette.error[850],
        ...
        colorSuccess: {
          '& .MuiChip-avatar': {
            backgroundColor: foundationNext.palette.success.light,
            color: foundationNext.palette.success[850],
          },
          '& .MuiChip-deleteIcon': {
            color: foundationNext.palette.success[850],
        ...
        colorWarning: {
          '& .MuiChip-avatar': {
            backgroundColor: foundationNext.palette.warning.light,
            color: foundationNext.palette.warning[850],
          },
          '& .MuiChip-deleteIcon': {
            color: foundationNext.palette.warning[850],
