...
const shadowValues = {
  /* Elevation 4 */
  4: `0px 2px 4px -1px ${alpha(paletteNext.shadow.main, 0.1)},
        0px 4px 5px ${alpha(paletteNext.shadow.main, 0.05)},
        0px 1px 10px ${alpha(paletteNext.shadow.main, 0.1)}`,
  /* Elevation 8 = Elevation 16 */
  8: `0px 8px 10px -5px ${alpha(paletteNext.shadow.main, 0.1)},
        0px 16px 24px 2px ${alpha(paletteNext.shadow.main, 0.05)},
        0px 6px 30px 5px ${alpha(paletteNext.shadow.main, 0.1)}`,
  /* Elevation 16 */
  16: `0px 8px 10px -5px ${alpha(paletteNext.shadow.main, 0.1)},
        0px 16px 24px 2px ${alpha(paletteNext.shadow.main, 0.05)},
        0px 6px 30px 5px ${alpha(paletteNext.shadow.main, 0.1)}`,
};
...
const foundationNext: Theme = createTheme({
  ...
  typography: {
    ...
    allVariants: {
      color: paletteNext.text.primary,
    },
    /* Using a constant because type variants
