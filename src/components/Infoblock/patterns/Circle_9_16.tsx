...
export const Circle_9_16 = (props: SvgIconProps): JSX.Element => (
  <SvgIcon viewBox="0 0 268 472" {...props}>
    ...
    <circle cx="4" cy="470" r="4" fill="#EEEEEE" />
    <circle cx="30" cy="470" r="4" fill="#EEEEEE" />
    <circle cx="56" cy="470" r="4" fill="#EEEEEE" />
    <circle cx="82" cy="470" r="4" fill="#EEEEEE" />
    <circle cx="108" cy="470" r="4" fill="#EEEEEE" />
    <circle cx="134" cy="470" r="4" fill="#EEEEEE" />
    <circle cx="160" cy="470" r="4" fill="#EEEEEE" />
    <circle cx="186" cy="470" r="4" fill="#EEEEEE" />
    <circle cx="212" cy="470" r="4" fill="#EEEEEE" />
    <circle cx="238" cy="470" r="4" fill="#EEEEEE" />
    <circle cx="264" cy="470" r="4" fill="#EEEEEE" />
  </SvgIcon>
);
