...
const colorMap = {
  primary: foundation.palette.secondary.main,
  dark: foundation.palette.common.black,
  light: foundation.palette.common.white,
  'light-primary': foundation.palette.common.white,
};

const colorRoundedMap = {
  primary: {
    circle: foundation.palette.common.white,
    monogram: foundation.palette.secondary.main,
  },
  dark: {
    circle: foundation.palette.common.black,
    monogram: foundation.palette.common.white,
  },
  light: {
    circle: foundation.palette.common.white,
    monogram: foundation.palette.common.black,
  },
  'light-primary': {
    circle: foundation.palette.secondary.main,
    monogram: foundation.palette.common.white,
  },
};
